...
class IblockController extends BaseController
{
    ...
    public function elementAction(): ElementDetailDto
    {
        ...
        if ($element_code = $this->request->get('element_code')) {
            return $this->service->getElementByCode($element_code, $properties);
        }
        if ($element_id = $this->request->get('element_id')) {
            return $this->service->getElementById((int) $element_id, $properties);
        }
    }
